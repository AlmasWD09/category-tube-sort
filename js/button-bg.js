...
const loadCategory = async () =>{
    const url = 'https://openapi.programming-hero.com/api/videos/categories'; //Button background color set kora complate hoyni
...
const displayCategorie = (categories) =>{
    categories.forEach(singleCategorie => {
        ...
        newBtn.className = `category-button btn`
...
const displayCategorieCard = (cards) =>{
   ...
   cards.forEach(singleCard =>{
    ...
    <h3  class="bg-slate-200  px-10 py-2 ">4hours,30minutes</h3>
    </div>
